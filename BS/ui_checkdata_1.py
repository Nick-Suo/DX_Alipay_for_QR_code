...
import pymysql
from PyQt5.QtCore import pyqtSignal, QThread, QSize, QDate
...
from u_func_checkdata import fenxi, jingrongzoushi
...
class Window(QWidget, Ui_Form):
    ...
    def pb_caipingfenxitu_click(self):
        ...
        self.p = fenxi(self.pb_txt, self.dt, db)
        time.sleep(1)
        ...
        self.label.setPixmap(QPixmap('fengxi.png'))
        pass
